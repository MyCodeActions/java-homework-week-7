...
/**
 * 14. Write a class with the name Person. The class needs three fields (instance variables) with the names
...
public class Person {
    ...
    // Declaring three instance variable
    ...
    // Main method to test the functionality of the Person class
